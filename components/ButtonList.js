...
import {Text, ScrollView, TouchableOpacity, StyleSheet, Image, View, Button} from 'react-native'
...
class List extends Component {
        ...
        this.state = {
            names: [
                ...
                },
                {
                    id: 3,
                    name: 'Spotify',
                    uri: 'https://images.idgesg.net/images/article/2018/11/spotify-logo-100779042-large.3x2.jpg',
                    lastActive: '',

                    style: styles.buttonSpotifyStyle,
                    text: "Spotify (19.99zł)"
    ...
    render() {
        return (
            <ScrollView>
                {this.state.names.map((subscription) =>
                ...
                <Button title={'Odswiez'} onPress={() => {
                    var currentState = this.state.names

                    SharedPref.getAllDates()
                        .then((dates) => {
                            currentState[0].lastActive = dates[0]
                            currentState[1].lastActive = dates[1]
                            currentState[2].lastActive = dates[2]
                            currentState[3].lastActive = dates[3]
                        this.setState({
                            names: currentState
                        })
